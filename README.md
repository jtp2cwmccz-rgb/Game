...
| 🛺 TukTuk Dodge | Port del *TukTuk Dash: Bangkok Run*: esquiva-carriles cenital con el tuk-tuk abajo. Toca izquierda/derecha (o flechas/A-D) para cambiar de carril y esquivar elefantes 🐘, motos 🏍️ y artistas 💃, con palmeras en los arcenes y chispas al esquivar. Puntúas por tiempo + por cada esquive, y la velocidad rampa de forma continua con la partida. |
...
| 🍺 Caña Perfecta | El arte de tirar la cerveza en **un solo intento** por cliente: mantén para abrir el grifo (la presión sube sola y a más presión, más espuma) y **suelta para servir** con el nivel en la marca y dos dedos de espuma. 8 clientes con pedidos distintos (caña, tubo, jarra); rebosar arruina la ronda y cada cliente el grifo viene más bravo. |
...
| 🧱 Jenga Neón | Estilo *Jenga*: toca un bloque para sacarlo de la torre; cada extracción la inclina según el lado (alterna izquierda/derecha para reequilibrar) y no puedes dejar una fila vacía. Cada 3 bloques crece una fila nueva arriba. +50 por bloque con combo de equilibrio; si se inclina demasiado o quitas un apoyo clave, se derrumba. |
